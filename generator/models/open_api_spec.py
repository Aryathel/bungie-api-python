...
from .open_api_security_definition import OpenAPISecurityDefinition
...
class OpenAPISpec:
    ...
    definitions: Optional[dict[str, OpenAPIDefinition]] = field(default=None)
    ...
    securityDefinitions: Optional[dict[str, OpenAPISecurityDefinition]] = field(default=None)
